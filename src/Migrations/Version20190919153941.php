 ...
 */
final class Version20190919153941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budget CHANGE year_name name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE budget CHANGE name year_name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
